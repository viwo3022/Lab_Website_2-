...
function viewStudentStats(id, toggle){
	if(toggle == 1){
		...
		document.getElementById(id).style.height = "zero";
	}
}
/*
	Home Page:
...
function loadStatsPage(){
	...
	for (row_counter = 2; row_counter < length; row_counter++){
...
function loadPlayersPage(){
	...
	for( var i =0; i< players.length; i++){
		a = a + '<p><a href = # onclick = switchPlayers(' + i + ')>' + players[i].name + '</a><p>'
...
function switchPlayers(playerNum){
	...
	var AvPYards = document.getElementById("p_yards").innerHTML / document.getElementById("g_played").innerHTML;
	var AvRYards = document.getElementById("r_yards").innerHTML /document.getElementById("g_played").innerHTML;
	var AvRecYards = document.getElementById("rec_yards").innerHTML/document.getElementById("g_played").innerHTML;

	document.getElementById("avg_p_yards").innerHTML = AvPYards.toFixed(2);
	document.getElementById("avg_r_yards").innerHTML = AvRYards.toFixed(2);
	document.getElementById("avg_rec_yards").innerHTML = AvRecYards.toFixed(2);
